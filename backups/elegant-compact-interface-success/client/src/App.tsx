    ...
    <nav className="relative">
      ...
      <div className="relative bg-card border-b border-border">
        <div className="container mx-auto px-6 py-6">
          ...
          {/* Navigation columns */}
          <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-2 xs:gap-3 sm:gap-4 md:gap-5 lg:gap-6 max-w-6xl mx-auto">
            <Link href="/">
            ...
            <Link href="/tabuadas">
              <div className={`h-24 xs:h-28 sm:h-32 md:h-34 lg:h-36 xl:h-40 px-2 xs:px-3 sm:px-4 md:px-5 lg:px-6 py-2 xs:py-3 sm:py-4 md:py-5 lg:py-6 rounded-xl lg:rounded-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer border-2 shadow-md flex flex-col justify-center ${
                ...
                <div className="text-center">
                  ...
                  <div className="font-greek font-bold text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl leading-tight">Tabuadas</div>
                  <div className="text-xs xs:text-xs sm:text-xs md:text-sm lg:text-sm xl:text-sm font-semibold opacity-90 leading-tight">Estudo Focado</div>
                </div>
              </div>
            </Link>
